...
const Interest = () => {
    ...
    return (
        <div className={style.main}>
            ...
            <p className={style.text}>В этом разделе я сделала подборку для предпринимателей по интернет-сервисам, которые могут пригодиться в работе.
                Речь пойдет о бесплатных общедоступных ресурсах.</p>
            <div className={style.position}>
                <TextBlock sds={false} img={image1} href="Регистрация ИП" src="https://service.nalog.ru/gosreg/#ip" text="Сервис позволяет заполнить следующие виды заявлений с возможностью представления в регистрирующий орган (лично или в электронном виде):" li={array}/>
                <TextBlock sds={false} img={image2} href="Выбор подходящего режима налогообложения" src="https://www.nalog.gov.ru/rn77/service/mp/" text="Этот калькулятор от ФНС поможет определиться с выбором режима налогообложения." li={a}/>
                <TextBlock sds={false} img={image3} href="Личный кабинет ИП" src="https://lkip2.nalog.ru/lk#/login" text="В ЛК легко зарегистрироваться, можно зайти туда по учетной записи с портала госуслуг.
                ...
                <TextBlock sds={false} img={image6} href="Прозрачный бизнес" src="https://pb.nalog.ru/index.html" text="Этот сервис позволяет получить комплексную информацию о налогоплательщике. Он полезен, в том числе, для целей проверки контрагентов при проявлении должной осмотрительности.
                В этом сервисе можно получить свою выписку из ЕГРИП и выписки из ЕГРИП/ЕГРЮЛ на контрагентов." li={a}/>
                <TextBlock sds={false} img={image4} href="Информирование о приостановлениях по расчетному счету" src="https://service.nalog.ru/bi.do" text="Этот сервис позволяет узнать о действующих решениях о приостановлении операций по счету ИП или по счетам контрагентов." li={array}/>
                <TextBlock sds={false} img={image7} href="Уплата налогов" src="https://service.nalog.ru/payment/#ip" text="Сервис поможет заполнить платежный документ на перечисление налогов, страховых взносов." li={a}/>
